 ...
 * @author duong
 */
public class ManagerBill extends javax.swing.JFrame {
    DefaultTableModel model = null;
    static Account acc = null;
    String [] Tile = {"STT","Mã hóa đơn","Bàn","Nhân viên thu ngân","Tên khách hàng", "Thành tiền", "Ngày tạo"};
    ...
    public ManagerBill() {
        initComponents();
        model =  (DefaultTableModel) tbBill.getModel();
        model.setColumnIdentifiers(Tile);
        ShowTable();
    }
    public ManagerBill(int idUser) {
        initComponents();
    ...
    public void  ShowTable(){
        listBill = BillController.getAllBill(from, to);

        model.setRowCount(0);
        int stt =1;
        for (Bill bill : listBill) {
            String tableName = bill.getTable() == null ? "" : bill.getTable().getTbName();
            String empName = bill.getEmployee() == null ? "" : bill.getEmployee().getFullname();
            String cusName = bill.getCustomer() == null ? "" : bill.getCustomer().getFullname();
            model.addRow(new Object[]{
                stt++,bill.getIdBill(), tableName, empName, cusName, bill.getTotal(),bill.getCreatedAt()
            });
        }
    }
    /**
    ...
    private void initComponents() {
        ...
        tbBill.setForeground(new java.awt.Color(46, 0, 0));
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(txtDateFrom, javax.swing.GroupLayout.PREFERRED_SIZE, 143, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(14, 14, 14)))
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(jLabel1)
                        .addComponent(jLabel2)
                        .addComponent(txtDateFrom, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(txtDateTo, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        CreateBill createBill = new CreateBill(acc.getIdUser());
    ...
    private void btnUpdateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnUpdateMouseClicked
        ...
        int idBill = (int)tbBill.getValueAt(row, 1);
        Bill bill = BillController.getBill(idBill);
        if(bill == null) {
            JOptionPane.showMessageDialog(null, "Không tìm thấy hóa đơn này", "Lỗi", JOptionPane.ERROR_MESSAGE);
        ...
        UpdateBill updateBill = new UpdateBill(acc.getIdUser());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManagerBill.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ManagerBill().setVisible(true);
            }
        });
    }
