...
public class UpdateExpense extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnExpenseUpdate = new javax.swing.JButton();
        ...
        jLabel4.setText("CẬP NHẬT BIÊN LAI");
        ...
        btnExpenseUpdate.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        btnExpenseUpdate.setIcon(new javax.swing.ImageIcon(getClass().getResource("/qlnhahang_btln5/images/Tick.png"))); // NOI18N
        btnExpenseUpdate.setText("Cập nhật");
        btnExpenseUpdate.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                btnExpenseUpdateMouseClicked(evt);
            }
        });
        btnExpenseUpdate.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnExpenseUpdateActionPerformed(evt);
            }
        });
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGap(28, 28, 28)
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                    .addComponent(btnExpenseUpdate, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnExpenseUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExpenseUpdateActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_btnExpenseUpdateActionPerformed

    private void btnExpenseUpdateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnExpenseUpdateMouseClicked
        // TODO add your handling code here:
        errExpense.setText(null);
        msgExpense.setText(null);
        ...
        if(ExpenseController.updateExpense(expense.getIdExp(), itemEmployee.getValue(),listDetail)) {
            msgExpense.setText("Cập nhật biên lai thành công.");
            showTableEquipment();
            showTableMaterial();
        } else {
            errExpense.setText("Cập nhật biên lai thất bại.");
        }
    }//GEN-LAST:event_btnExpenseUpdateMouseClicked
    ...
    private javax.swing.JButton btnExpenseUpdate;
