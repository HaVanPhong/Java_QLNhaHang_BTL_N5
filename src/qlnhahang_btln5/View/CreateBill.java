...
public class CreateBill extends javax.swing.JFrame {
    ...
    public CreateBill() {
        ...
        for(Customer customer : listCustomer) {
            cbbCustomer.addItem(new ComboItem(customer.getFullname(), customer.getIdCus()));
        }
        ...
        for(Tables table : listTable) {
            cbbTable.addItem(new ComboItem(table.getTbName(), table.getIdTB()));
        }
        showTableDish();
    }
    public CreateBill(int idUser) {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnBillAdd = new javax.swing.JButton();
        ...
        btnBillAdd.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        btnBillAdd.setIcon(new javax.swing.ImageIcon(getClass().getResource("/qlnhahang_btln5/images/Create.png"))); // NOI18N
        btnBillAdd.setText("Tạo hóa đơn");
        btnBillAdd.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                btnBillAddMouseClicked(evt);
            }
        });
        btnBillAdd.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnBillAddActionPerformed(evt);
            }
        });
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(btnBillAdd, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnBillAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBillAddActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_btnBillAddActionPerformed
    ...
    private void btnBillAddMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnBillAddMouseClicked
        // TODO add your handling code here:
        ...
        if(BillController.createBill(itemCustomer.getValue(), 
                itemEmployee.getValue(), itemTable.getValue(), total, listDetail)) {
            btnBillRefreshMouseClicked(evt);
            msgBill.setText("Tạo hóa đơn thành công.");
            
        } else {
            errBill.setText("Tạo hóa đơn thất bại.");
        }
        
    }//GEN-LAST:event_btnBillAddMouseClicked
    ...
    private javax.swing.JButton btnBillAdd;
